...
import { DiscountConfiguration, TaxConfiguration, CalculationResult, ItemCalculationResult } from './quotation.types';

@Injectable()
export class QuotationCalculatorService {
  /**
   * Calculates the totals for a quotation including all items, discounts, and taxes.
   */
  calculateTotals(
    items: any[], 
