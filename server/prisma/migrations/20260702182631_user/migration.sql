...
-- AlterTable
ALTER TABLE "branches" ADD COLUMN     "quotationTheme" TEXT NOT NULL DEFAULT 'INDUX_MODERN',
ADD COLUMN     "tax" INTEGER NOT NULL DEFAULT 0,
ADD COLUMN     "taxLabel" TEXT NOT NULL DEFAULT '',
ADD COLUMN     "themeColor" TEXT NOT NULL DEFAULT '#0ea5e9';
